...
// This DAO handles operations for the 'position' table.
public class PositionDAO {

    private static final Logger LOGGER = Logger.getLogger(PositionDAO.class.getName());

    /**
     * Retrieves the PositionID for a given position name.
     *
     * @param positionName The name of the position (e.g., "HR Manager").
     * @return The PositionID, or -1 if the position is not found.
    ...
    /**
     * Retrieves the PositionName for a given PositionID.
     *
     * @param positionId The ID of the position.
     * @return The PositionName, or null if the ID is not found.
     * @throws SQLException if a database access error occurs.
     */
    ...
    public List<String> getAllPositionNames() throws SQLException {
        ...
        String sql = "SELECT PositionName FROM position WHERE IsDeleted = 0"; // Assuming soft delete
